  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { 
        role: 'assistant', 
        content: "I apologize, but I'm having trouble connecting. Please call us at (877) 609-1919 for immediate assistance." 
      }]);
    } finally {
      setIsLoading(false);
    }
        ...
        >
          ...
          <div className="p-4 bg-white border-t border-gray-200">
            ...
            <p className="text-xs text-gray-400 text-center mt-2">
              Call <a href="tel:+18776091919" className="text-amber-600 hover:underline">(877) 609-1919</a> for immediate help
            </p>
          </div>
        </div>
      )}
